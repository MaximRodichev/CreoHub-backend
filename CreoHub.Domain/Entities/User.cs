...
public class User
{
    ...
    /// <summary>
    /// Потолок экономии велком-скидки в валюте заказа ($10).
    /// Полные 20% действуют до заказа в $50; выше — экономия фиксируется на $10.
    /// Защита от абуза: иначе свежий аккаунт утаскивал бы −20% на крупном опте без предела
    /// (фарм одноразовых аккаунтов под оптовые закупки). Лояльность и объём НЕ капаются.
    /// </summary>
    public const decimal FirstOrderDiscountCap = 10m;
